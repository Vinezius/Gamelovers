...
Future<void> _uploadImage() async {
  ...
  Reference storageReference = FirebaseStorage.instance.ref().child('profiles/$fileName');
  ...
  try {
    ...
    if (snapshot.state == TaskState.success) {
      ...
      if (user != null) {
        ...
        await userRepository.saveAll(user!); // Salva as alterações no Firestore
        setState(() {
...
>>>>>>> ddcf483b9a78fac58e7a33f8460b046e299ea0c2
  }
}
